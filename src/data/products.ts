...
//  absolut, ex: "/images/ciubar1.png"). Pentru a schimba o imagine, înlocuiește
...
export const products: Product[] = [
  // 1 ─────────────────────────────────────────────────────────────────────
  {
    ...
    features: [
      ...
      'Sobă din inox inclusă',
      'Scăriță de acces inclusă',
      'Sistem de scurgere prin sobă',
    ],
    prices: [
  ...
  // 4 ─────────────────────────────────────────────────────────────────────
  {
    ...
    features: [
      ...
      'Sobă exterioară',
      'Sistem de scurgere acționat la buton',
      'Coș de fum din inox cu pălărie de protecție inclusă',
    ],
    prices: [
  ...
  // 7 ─────────────────────────────────────────────────────────────────────
  {
    ...
    badges: ['Base', '225 cm', 'Eficiență termică'],
    tags: ['225', 'rotund', 'base'],
  },
  ...
  // 8 ─────────────────────────────────────────────────────────────────────
  {
    ...
    badges: ['Comfort', '225 cm', 'Aero / Hidromasaj'],
    tags: ['225', 'rotund', 'comfort'],
  },
  ...
  // 9 ─────────────────────────────────────────────────────────────────────
  {
    ...
    badges: ['Luxury', '225 cm', 'Spa complet'],
    tags: ['225', 'rotund', 'luxury'],
    popular: true,
  },
  ...
  // 10 ────────────────────────────────────────────────────────────────────
  {
    ...
    name: 'PMPFiber Square Spa Base',
    category: 'patrat',
    categoryLabel: 'Ciubăr pătrat',
    tier: 'Base',
    shape: 'patrat',
  ...
  // 11 ────────────────────────────────────────────────────────────────────
  {
    ...
    name: 'PMPFiber Square Spa Comfort',
    category: 'patrat',
    categoryLabel: 'Ciubăr pătrat',
    tier: 'Comfort',
    shape: 'patrat',
    ...
    badges: ['Comfort', 'Design pătrat', 'Aero / Hidromasaj'],
    tags: ['patrat', 'comfort'],
  },
  ...
  // 12 ────────────────────────────────────────────────────────────────────
  {
    ...
    name: 'PMPFiber Square Spa Luxury',
    category: 'patrat',
    categoryLabel: 'Ciubăr pătrat',
    tier: 'Luxury',
    shape: 'patrat',
    ...
    badges: ['Luxury', 'Design pătrat', 'Spa complet'],
    tags: ['patrat', 'luxury'],
  },
